					...
					<div class="card-body p-0 rounded-0">
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block rounded-0">
								<img class="mt-3 ml-logo" src="<?= base_url('assets/ypbpi.png') ?>" width="300px" height="300px" alt="YPBPI">
							</div>
							<div class="col-lg-6 rounded-0">
								<div class="p-5 rounded-0">
									...
									<form method="post" action="<?= base_url('Login') ?>">
										...
										<div class="form-group">
											<input type="password" name="password" value="<?= set_value('password') ?>" class="form-control form-control-user rounded-0" placeholder="Password" autocomplete>
